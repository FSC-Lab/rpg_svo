...
public:
  ...
  /// Get the std::set of spatially closest keyframes of the last frame.
...
protected:
  ...
  std::vector< std::pair<FramePtr,size_t> > overlap_kfs_; //!< All keyframes with overlapping field of view. the paired number specifies how many common mappoints are observed TODO: why std::vector!?
