...
void FrameHandlerMono::addImage(const cv::Mat& img, const double timestamp)
{
  ...
  if(stage_ == STAGE_DEFAULT_FRAME)
    ...
    res = relocalizeFrame(Sophus::SE3d(Matrix3d::Identity(), Vector3d::Zero()),
...
{
  new_frame_->T_f_w_ = Sophus::SE3d(Matrix3d::Identity(), Vector3d::Zero());
    ...
    FramePtr ref_keyframe)
{
  ...
  {
    Sophus::SE3d T_f_w_last = last_frame_->T_f_w_;
