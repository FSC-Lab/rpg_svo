...
void BenchmarkNode::tracePose(const Sophus::SE3d& T_w_f, const double timestamp)
{
...
void BenchmarkNode::tracePoseError(const Sophus::SE3d& T_f_gt, const double timestamp)
{
